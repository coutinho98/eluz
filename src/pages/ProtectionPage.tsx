...
const ProtectionPage = () => {
    return (
        <div className="w-full relative overflow-x-hidden min-h-screen">
            ...
            <header className={`py-32 px-4 md:px-8 text-white ${PURPLE_BG} w-full`}>
                <div className="max-w-7xl mx-auto text-center">
                    <CloudLightning className="w-20 h-20 text-yellow-500 mx-auto mb-4" />
                    <h1 className="font-[ranade] text-6xl md:text-7xl font-bold mb-4">
                        Proteção Elétrica <span className="text-yellow-500">Total</span>
                    </h1>
                    <p className="text-2xl font-light max-w-3xl mx-auto">
                        Seu Ativo Mais Importante Contra Raios, Surtos e Danos. SPDA, MPS, Aterramento e Gerenciamento de Risco.
                    </p>
                    <a 
                        href="#contato" 
                        className="mt-8 inline-block px-10 py-4 bg-yellow-500 text-gray-900 text-xl font-bold rounded-full hover:bg-yellow-400 transition transform hover:scale-105 shadow-xl"
                    >
                        Solicitar Orçamento
                    </a>
                </div>
            ...
            <section className="py-16 bg-white px-4 md:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-6 border-l-4 border-yellow-500 text-left">
                            <Shield className={`w-8 h-8 ${PURPLE_STRONG} mb-3`} />
                        ...
                        <div className="p-6 border-l-4 border-yellow-500 text-left">
                            <DollarSign className={`w-8 h-8 ${PURPLE_STRONG} mb-3`} />
                        ...
                        <div className="p-6 border-l-4 border-yellow-500 text-left">
                            <TrendingUp className={`w-8 h-8 ${PURPLE_STRONG} mb-3`} />
            ...
            <section id="detalhes" className="w-full bg-gray-50 py-24 px-4 md:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <h3 className="font-[ranade] text-5xl font-bold text-gray-900 mb-4">
                        Nossos Pilares de <span className="text-violet-700">Proteção</span>
                    </h3>
